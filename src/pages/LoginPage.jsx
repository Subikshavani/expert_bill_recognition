    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-4">
      ...
      <div className="relative z-10 w-full max-w-md rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-2xl backdrop-blur-xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-xs uppercase tracking-[0.24em] text-blue-500">Company Logo</p>
        ...
        <form className="space-y-4" onSubmit={submit}>
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-blue-500 px-4 py-2.5 text-sm font-bold text-white shadow-[0_10px_32px_rgba(6,182,212,0.35)] transition hover:scale-[1.01]"
          >
            Login To Dashboard
          </button>
        </form>
